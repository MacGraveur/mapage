...
## Attention image de charnier

Cet exemple d'utilisation de l'IAG montre les énormes problématiques de production de faux historiques, alors même que l'intention est de rendre hommage aux victimes de la Shoah.

![capture d'un compte Instagram qui expose une image produit via IAG où l'on voit un officier SS et un charnier, mais les corps resssemblent plutôt à des alliens. Un texte d'hommage aux victimes est écrit sur le côté](/blocnotes/noiag/insta.png)

[lien vers la source](https://www.instagram.com/reel/DYtJqmsqShJ/)
...
[^1]: ![capture du compte Facebook des AD de Haute-Garonne expliquant que les crawlers d'IAG font tomber leur site](/blocnotes/noiag/AD82.png).